...
export const zh = {
  ...
  'stats.deepseekUsage': '{cost}',
  'stats.deepseekFormulaModel': '{model}：',
  'stats.deepseekFormulaPeak': '高峰',
  'stats.deepseekFormulaOffPeak': '空闲',
  'stats.deepseekFormulaLabelUncached': '输入（缓存未中）',
  'stats.deepseekFormulaLabelCacheRead': '输入（缓存命中）',
  'stats.deepseekFormulaLabelCacheWrite': '输入（缓存写入）',
  'stats.deepseekFormulaLabelOutput': '输出',
...
export const en = {
  ...
  'stats.deepseekUsage': '{cost}',
  'stats.deepseekFormulaModel': '{model}:',
  'stats.deepseekFormulaPeak': 'Peak',
  'stats.deepseekFormulaOffPeak': 'Off-peak',
  'stats.deepseekFormulaLabelUncached': 'Input (cache miss)',
  'stats.deepseekFormulaLabelCacheRead': 'Input (cache hit)',
  'stats.deepseekFormulaLabelCacheWrite': 'Input (cache write)',
  'stats.deepseekFormulaLabelOutput': 'Output',
