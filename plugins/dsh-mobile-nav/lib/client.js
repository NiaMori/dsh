...
__modules["effects/haptic-pref.js"] = function (require, module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.HAPTIC_INTENSITY_KEY = exports.HAPTIC_EVENT = exports.HAPTIC_KEY = void 0;
exports.readHapticEnabled = readHapticEnabled;
exports.writeHapticEnabled = writeHapticEnabled;
exports.readHapticIntensity = readHapticIntensity;
exports.writeHapticIntensity = writeHapticIntensity;
/**
 ...
 */
exports.HAPTIC_KEY = 'dsh-mobile-nav.haptic.enabled';
exports.HAPTIC_EVENT = 'dsh-mobile-nav:haptic-pref';
exports.HAPTIC_INTENSITY_KEY = 'dsh-mobile-nav.haptic.intensity';
function readHapticEnabled() {
    try {
        const raw = localStorage.getItem(exports.HAPTIC_KEY);
...
function writeHapticEnabled(enabled) {
    try {
        localStorage.setItem(exports.HAPTIC_KEY, enabled ? '1' : '0');
    }
    catch {
    ...
    document.dispatchEvent(new CustomEvent(exports.HAPTIC_EVENT));
}
function readHapticIntensity() {
    try {
        const raw = localStorage.getItem(exports.HAPTIC_INTENSITY_KEY);
...
function writeHapticIntensity(intensity) {
    try {
        localStorage.setItem(exports.HAPTIC_INTENSITY_KEY, intensity);
    }
    catch {
...
__modules["HapticRow.js"] = function (require, module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.HapticRow = HapticRow;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = require("react");
const dsh_client_ui_primitives_1 = require("@deepseek-ai/dsh-client-ui-primitives");
const haptic_pref_ts_1 = require("./effects/haptic-pref.js");
 ...
 * uninstalled state).
 */
function HapticRow({ t }) {
    const [enabled, setEnabled] = (0, react_1.useState)(haptic_pref_ts_1.readHapticEnabled);
    const [intensity, setIntensity] = (0, react_1.useState)(haptic_pref_ts_1.readHapticIntensity);
    const [open, setOpen] = (0, react_1.useState)(false);
    const activeLabel = INTENSITIES.find((o) => o.id === intensity)?.labelKey ?? 'haptic.intensity.light';
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-mobile-nav-haptic-row", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-mobile-nav-haptic-title", children: t('haptic.title') }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-mobile-nav-haptic-desc", children: t('haptic.desc') }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-mobile-nav-haptic-controls", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", role: "switch", "aria-checked": enabled, "aria-label": t('haptic.title'), className: "dsh-mobile-nav-haptic-switch", "data-on": enabled ? '' : undefined, onClick: () => {
                            const next = !enabled;
                            (0, haptic_pref_ts_1.writeHapticEnabled)(next);
                            setEnabled(next);
                            if (!next)
                                setOpen(false);
                        }, children: (0, jsx_runtime_1.jsx)("span", { className: "dsh-mobile-nav-haptic-thumb" }) }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Menu, { open: open, onClose: () => setOpen(false), items: INTENSITIES.map((o) => ({ id: o.id, label: t(o.labelKey) })), selectedId: intensity, onSelect: (id) => {
                            const next = id === 'medium' || id === 'heavy' ? id : 'light';
                            (0, haptic_pref_ts_1.writeHapticIntensity)(next);
                            setIntensity(next);
                            setOpen(false);
                        }, align: "end", portal: true, anchor: (0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-mobile-nav-haptic-selector", "aria-haspopup": "menu", "aria-expanded": open, "aria-label": t('haptic.intensityLabel'), disabled: !enabled, onClick: () => setOpen((v) => !v), children: [t(activeLabel), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconChevronDownOutline14, { className: "dsh-mobile-nav-haptic-chevron" })] }) })] })] }));
}
};
...
__modules["effects/haptic.js"] = function (require, module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.installHaptic = installHaptic;
const haptic_pref_ts_1 = require("./effects/haptic-pref.js");
...
function installHaptic(ctx) {
    ctx.effect(() => {
        ...
        const install = () => {
            cleanup?.();
            if (!narrow.matches || !(0, haptic_pref_ts_1.readHapticEnabled)() || typeof navigator.vibrate !== 'function') {
                cleanup = undefined;
                return;
            }
            let last = 0;
            const onTap = (event) => {
                ...
                if (now - last < 60)
                    return;
                last = now;
                navigator.vibrate(INTENSITY_MS[(0, haptic_pref_ts_1.readHapticIntensity)()]);
            };
            document.addEventListener('click', onTap, true);
        ...
        const onStorage = (event) => {
            ...
            if (event.key === null || event.key === haptic_pref_ts_1.HAPTIC_KEY)
                install();
        };
        const onPref = () => install();
        install();
        narrow.addEventListener('change', install);
        document.addEventListener(haptic_pref_ts_1.HAPTIC_EVENT, onPref);
        window.addEventListener('storage', onStorage);
        return () => {
            narrow.removeEventListener('change', install);
            document.removeEventListener(haptic_pref_ts_1.HAPTIC_EVENT, onPref);
...
const HapticRow_tsx_1 = require("./HapticRow.js");
const index_ts_1 = require("./styles/index.js");
const debug_ts_1 = require("./debug.js");
const phone_chrome_ts_1 = require("./effects/phone-chrome.js");
const aionui_compat_ts_1 = require("./effects/aionui-compat.js");
const haptic_ts_1 = require("./effects/haptic.js");
...
function apply(ctx) {
    ...
    (0, haptic_ts_1.installHaptic)(ctx);
